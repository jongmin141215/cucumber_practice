...
Scenario: Non logged in user cannot create course
  Given I am on the home page
  And I click "All courses" link
  Then I should not see "Create courses"

Scenario: Non logged in user cannot access the create new course form
